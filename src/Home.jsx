          ...
          <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
            ...
            <div className="relative flex items-center bg-gray-100">
              ...
              <div className="p-8 sm:p-16 lg:p-24">
                <h2 className="text-2xl font-bold sm:text-3xl text-brown-800">
        ...
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              <h2 className="text-3xl font-bold sm:text-4xl">The services we provide</h2>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              ...
              >
                ...
                <h2 className="mt-2 font-bold">3D Architectural Visualisation</h2>

                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                Immerse clients in stunning, lifelike representations of architectural designs. Precision meets creativity!
                </p>
              </a>
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Interior 3D Visualisation</h2>

                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                Transform ideas into vibrant, realistic interiors. See your space come alive before it's built!
                </p>
              </a>
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Animated 3D Walkthrough</h2>

                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                  Experience the future with dynamic animated tours. Walk through your designs in a captivating virtual world!
                </p>
              </a>
